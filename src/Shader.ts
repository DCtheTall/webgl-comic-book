...
export default class Shader {
  private hasSentAttributes: boolean;
  private program: WebGLProgram;
  private readonly shaderSources: Map<number, string> = new Map();
  ...
  public sendAttributes(gl: WebGLRenderingContext) {
    if (this.hasSentAttributes) return;
  ...
  private sendVectorAttribute(
      gl: WebGLRenderingContext, dimension: number,
